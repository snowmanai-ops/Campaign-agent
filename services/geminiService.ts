...
const emailSchema: Schema = {
  ...
  properties: {
    ...
    body: {
      type: Type.OBJECT,
      properties: {
        hook: { type: Type.STRING, description: "Opening line to grab attention" },
        context: { type: Type.STRING, description: "Why this email matters now" },
        value: { type: Type.STRING, description: "Main valuable content" },
        cta: { type: Type.STRING, description: "Call to action text" },
        signOff: { type: Type.STRING, description: "Closing sign-off" }
      },
      required: ["hook", "context", "value", "cta", "signOff"]
    }
  },
